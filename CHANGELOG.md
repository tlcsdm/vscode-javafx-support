...
- Add FXML diagnostics for missing `fx:controller` classes, duplicate `fx:id` values, unresolved controller fields, missing event handlers, and missing statically inferred ResourceBundle keys
